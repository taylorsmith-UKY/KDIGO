...
for FEATURE in "base_model" "base_model_withTrajectory" "clinical_model_mortality" "clinical_model_mortality_wTrajectory" #  "sofa_apache_norm"
do
...
#for FEATURE in "max_kdigo_d03_norm" "base_model" "base_model_withTrajectory" "clinical_model_make" "clinical_model_make_wTrajectory"
#do
...
python3 evalReclassification.py  --config_file $CONFIG_FILENAME -t died_inp -class $MODEL -f sofa_apache_norm base_model base_model_withTrajectory clinical_model_mortality clinical_model_mortality_wTrajectory -eng $ENGINE
python3 evalReclassification.py  --config_file $CONFIG_FILENAME -t make90_disch_30dbuf_2pts_d50 -class $MODEL -f max_kdigo_d03_norm base_model base_model_withTrajectory clinical_model_make clinical_model_make_wTrajectory -eng $ENGINE
python3 evalReclassification.py  --config_file $CONFIG_FILENAME -t make90_disch_30dbuf_2pts_d50 -class $MODEL -survivors -f max_kdigo_d03_norm base_model base_model_withTrajectory clinical_model_make clinical_model_make_wTrajectory -eng $ENGINE

python3 evalReclassification.py  --config_file $CONFIG_FILENAME -t died_inp -class $MODEL -f sofa_apache_norm base_model base_model_withTrajectory clinical_model_mortality clinical_model_mortality_wTrajectory -eng $ENGINE -ext
python3 evalReclassification.py  --config_file $CONFIG_FILENAME -t make90_disch_30dbuf_2pts_d50 -class $MODEL -f max_kdigo_d03_norm base_model base_model_withTrajectory clinical_model_make clinical_model_make_wTrajectory -eng $ENGINE -ext
python3 evalReclassification.py  --config_file $CONFIG_FILENAME -t make90_disch_30dbuf_2pts_d50 -class $MODEL -survivors -f max_kdigo_d03_norm base_model base_model_withTrajectory clinical_model_make clinical_model_make_wTrajectory -eng $ENGINE -ext
